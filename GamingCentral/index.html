...
<div class="topnav">
    ...
    <a href = "login.html" class = "account" alt = "account">Account <i class="fas fa-user"></i></a>
    <a href = "cart.html" class = "shop" alt = "Shopping Cart"><i class="fas fa-shopping-cart"></i> Cart</a>

<!-- Search bar and button -->
<div class="search-container">
      <form action="/action_page.php">
        <input type = "text" placeholder = "Search..." onfocus="this.placeholder=''" onblur = "this.placeholder='Search...'" class = "search">
